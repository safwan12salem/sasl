...
export default function Layout() {
  ...
  const navItems = [
    ...
    { to: '/gigs', icon: Briefcase, label: 'Gig Central' },
    { to: '/marketplace', icon: ShoppingBag, label: t('marketplace') },
     { to: '/group-chat', icon: Users, label: 'Group Chat' },
    ...
    { to: '/ar-filters', icon: Camera, label: 'AR Filters' },
    { to: '/analytics', icon: TrendingUp, label: 'Analytics' },
    { to: '/live-audio', icon: Mic, label: 'Live Audio' },
    { to: '/meshchat', icon: MessageCircle, label: t('meshchat') },
    { to: '/ai-hub', icon: Sparkles, label: 'Sasl AI Hub' },
    { to: '/progress', icon: Star, label: 'Progress' },

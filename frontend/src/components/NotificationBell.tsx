...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      <AnimatePresence>
        {open && (
          <motion.div initial={{ opacity: 0, y: -10, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }} exit={{ opacity: 0, y: -10, scale: 0.95 }}  className="fixed right-4 mt-2 w-[95vw] max-w-[380px] bg-white dark:bg-gray-800 rounded-2xl shadow-2xl z-[70] overflow-hidden border border-gray-200 dark:border-gray-700">

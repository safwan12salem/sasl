...
export default function QRProfile({ username }: { username: string }) {
  ...
  return (
    <div className="text-center p-6">
      <h3 className="font-bold mb-4">Your QR Profile</h3>
      ...
      <div className="flex gap-2 mt-4 justify-center">
        ...
        <button onClick={() => { navigator.clipboard.writeText(profileUrl); toast.success('Link copied!'); }} className="btn-ghost text-sm flex items-center gap-1">
